                    ...
                    <div class="table-responsive m-t-40">
                        <table id="myTable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>S.No</th>
                                    <th>@lang('app.giftwisereports.user')</th>
                                    <th>@lang('app.giftwisereports.categories')</th>
                                    <th>@lang('app.giftwisereports.branch')</th>
                                    <th>@lang('app.giftwisereports.created')</th>
                                    <th>@lang('app.giftwisereports.points')</th>
                                    <th>@lang('app.giftwisereports.desc')</th>
...
@push('footer-script')
    ...
    lengthMenu: [
        ...
        [10, 25, 50, 100, 'All']
            ...
            ajax: '{!! route('admin.gift-reports.data') !!}',
