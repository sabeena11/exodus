                    ...
                    <form id="editSettings" class="ajax-form"> 
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="name" class="required">@lang('app.branch.name')</label>
                                <input type="text" class="form-control" id="name" name="name">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="unique_id" class="required">@lang('app.branch.unique_id')</label>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="email" class="required">@lang('app.branch.email')</label>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="required">@lang('app.branch.phone')</label>
                                <div class="form-row">
                                    <div class="col-sm-12">
