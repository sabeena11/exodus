                ...
                <form id="editSettings" class="ajax-form">
                    ...
                    <div class="col-md-4"> 
                        <div class="form-group">
                            <label class="required">@lang('app.menus.title')</label>
                            <input type="text" id="title" name="title" class="form-control">
                        </div>
                    </div>  
                    <div class="col-md-4"> 
                        <div class="form-group">
                            <label class="required">@lang('app.menus.link')</label>
                            <input type="text" id="link" name="link" class="form-control">
                        </div>
                    </div>
                    <div class="col-md-4"> 
                        <div class="form-group">
                            <label class="required">@lang('app.menus.position')</label>
                            <textarea id="position" name="position" rows="4" cols="50" class="form-control"></textarea>
                        </div>
                    </div>
