<div class="modal-header">
    <h4 class="modal-title">@lang('app.roles.addRole')</h4>
            ...
            @forelse($roles as $key=>$role)
                <tr id="role-{{ $role->id }}">
                    ...
                    <td>
                        ...
                        @else
                            <span class="text-danger">@lang('app.messages.defaultRoleCantDelete')</span>
                        @endif
                    </td>
                </tr>
            @empty
                <tr>
                    <td colspan="3">@lang('app.messages.noRoleFound')</td>
                </tr>
            @endforelse
            </tbody>
        </table>
            ...
            <div class="row">
                <div class="col-sm-12 ">
                    <div class="form-group">
                        <label>@lang('app.permission.roleName')</label>
