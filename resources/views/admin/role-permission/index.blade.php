    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="col-sm-12">
                        <a href="javascript:;" id="addRole" class="btn btn-success btn-sm btn-outline  waves-effect waves-light "><i class="fa fa-gear"></i> @lang("app.roles.addRole")</a>
                    </div>
                                        ...
                                        <tr class="bg-white">
                                            <th>
                                                <div class="form-group">
                                                    ...
                                                    >
                                                    <label for="select_all_permission_{{ $role->id }}">@lang('app.permission.selectAll')</label>
                                                </div>
                                            </th>
                                            <th>@lang('app.add')</th>
                                            <th>@lang('app.view')</th>
