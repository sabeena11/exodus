                ...
                <div class="card-body">
                    ...
                    <form id="editSettings" class="ajax-form">
                        ...
                        <div class="form-group">
                            <label for="created">@lang('app.updatelogs.created')</label>
                            <input type="text" class="form-control" id="created" name="created">
                        </div>
                        <div class="form-group">
                            <label for="enddevice">@lang('app.updatelogs.enddevice')</label>
                            <input type="text" class="form-control" id="enddevice" name="enddevice">
                        </div>
