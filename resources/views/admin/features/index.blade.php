...
@if (in_array('add_features', $userPermissions))
    @section('create-button')
        <a href="{{ route('admin.features.create') }}" class="btn btn-dark btn-sm m-l-15"><i class="fa fa-plus-circle"></i>
                        ...
                        <table id="myTable" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th>@lang('app.features.title')</th>
                                    <th>@lang('app.features.icon')</th>
        ...
        var table = $('#myTable').dataTable({
            ...
            columns: [{
                    ...
                    render: function(data, type, row) {
                        if (type === 'display') {
                            var baseUrl = "{{ url('/') }}"; 
                            return '<a href="' + baseUrl + '/admin/features/' + data + '/edit">'  + data + '</a>';
                        }
                        return data;
                    },
                },
