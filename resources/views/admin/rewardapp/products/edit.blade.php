    ...
    <div class="col-md-4">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <input type="file" id="input-file-now" name="image" accept=".png,.jpg,.jpeg"
                                        class="dropify" data-default-file="{{ asset('user-uploads/product/'.$product->image) }}" / >
                                </div>
                            </div>
                        </div>
       </div>
            <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <textarea id="desc" name="desc" rows="4" cols="50" class="form-control">{{$product->desc}} </textarea>
                        </div>
                 </div>
